...
<div id="<?php print $block_html_id; ?>" class="<?php print $classes; ?>">
  <?php if ($title): ?>
    <h2 class="title"><?php print $title; ?><a class='linkForEditMenuAtlas' href="<?php echo $base_url; ?>/admin/build/menu-customize/menu-menu-atlas-hp" alt='Modifier le menu' title='Modifier le menu' target='_blank'></a></h2>
  <?php endif; ?>
