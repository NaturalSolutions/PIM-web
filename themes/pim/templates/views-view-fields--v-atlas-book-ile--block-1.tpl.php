...
<?php if($language->language == 'fr'): ?>
  ...
  $sql = "SELECT n.title FROM pimPierre.drp_node n JOIN pimPierre.drp_content_type_book_les_pictos_surcharge s ON s.nid = n.nid;";
  $result = db_query($sql);
  if (!$result) die('Invalid query: ' . mysql_error());
  else while (  $row  =  db_fetch_array($result) ){
    ...
    */
    ...
    $idPictoMSurcharge = '';
    $sql = "SELECT n.nid, s.field_book_value_picto_surcharge_value, s.field_book_star_com_picto_value, s.field_book_star_on_picto_value FROM pimPierre.drp_node n LEFT JOIN pimPierre.drp_content_type_book_les_pictos_surcharge s ON s.nid = n.nid WHERE n.title='picto surcharge sur:".$nid."' AND s.field_book_type_picto_surcharge_value = 'fauneM' AND s.field_book_genre_picto_surcharge_value = 'connaissance';";
    $result = db_query($sql);  
    if (!$result) die('Invalid query: ' . mysql_error());
    else while (  $row  =  db_fetch_array($result) ) {
    ...
    */
    ...
    $idPictoMSurcharge = '';
    $sql = "SELECT n.nid, s.field_book_value_picto_surcharge_value, s.field_book_star_com_picto_value, s.field_book_star_on_picto_value FROM pimPierre.drp_node n LEFT JOIN pimPierre.drp_content_type_book_les_pictos_surcharge s ON s.nid = n.nid WHERE n.title='picto surcharge sur:".$nid."' AND s.field_book_type_picto_surcharge_value = 'floreM' AND s.field_book_genre_picto_surcharge_value = 'connaissance';";  
    $result = db_query($sql);  
    if (!$result) die('Invalid query: ' . mysql_error());
    else while (  $row  =  db_fetch_array($result) ) {
      $idPictoMSurcharge = $row['nid'];  
    ...
    */
    //Get nid of picto_surcharge to load the correct node edit form -> FloreM
    $idPictoMSurcharge = '';
    $sql = "SELECT n.nid, s.field_book_value_picto_surcharge_value, s.field_book_star_com_picto_value, s.field_book_star_on_picto_value FROM pimPierre.drp_node n LEFT JOIN pimPierre.drp_content_type_book_les_pictos_surcharge s ON s.nid = n.nid WHERE n.title='picto surcharge sur:".$nid."' AND s.field_book_type_picto_surcharge_value = 'grotte' AND s.field_book_genre_picto_surcharge_value = 'connaissance';";  
    $result = db_query($sql);  
    if (!$result) die('Invalid query: ' . mysql_error());
    else while (  $row  =  db_fetch_array($result) ) {
      $idPictoMSurcharge = $row['nid'];  
  ...
  */
  ...
  $idPictoMSurcharge = '';
  $sql = "SELECT n.nid, s.field_book_value_picto_surcharge_value, s.field_book_star_com_picto_value, s.field_book_star_on_picto_value FROM pimPierre.drp_node n LEFT JOIN pimPierre.drp_content_type_book_les_pictos_surcharge s ON s.nid = n.nid WHERE n.title='picto surcharge sur:".$nid."' AND s.field_book_type_picto_surcharge_value = 'botanique' AND s.field_book_genre_picto_surcharge_value = 'interet';";  
  $result = db_query($sql);  
  if (!$result) die('Invalid query: ' . mysql_error());
  else while (  $row  =  db_fetch_array($result) ) {
    $idPictoMSurcharge = $row['nid'];  
  ...
  */
  ...
  $idPictoMSurcharge = '';
  $sql = "SELECT n.nid, s.field_book_value_picto_surcharge_value, s.field_book_star_com_picto_value, s.field_book_star_on_picto_value FROM pimPierre.drp_node n LEFT JOIN pimPierre.drp_content_type_book_les_pictos_surcharge s ON s.nid = n.nid WHERE n.title='picto surcharge sur:".$nid."' AND s.field_book_type_picto_surcharge_value = 'ornithologie' AND s.field_book_genre_picto_surcharge_value = 'interet';";  
  $result = db_query($sql);  
  if (!$result) die('Invalid query: ' . mysql_error());
  else while (  $row  =  db_fetch_array($result) ) {
    $idPictoMSurcharge = $row['nid'];  
  ...
  */
  //Get nid of picto_surcharge to load the correct node edit form -> orni
  $idPictoMSurcharge = '';
  $sql = "SELECT n.nid, s.field_book_value_picto_surcharge_value, s.field_book_star_com_picto_value, s.field_book_star_on_picto_value FROM pimPierre.drp_node n LEFT JOIN pimPierre.drp_content_type_book_les_pictos_surcharge s ON s.nid = n.nid WHERE n.title='picto surcharge sur:".$nid."' AND s.field_book_type_picto_surcharge_value = 'herpetologie' AND s.field_book_genre_picto_surcharge_value = 'interet';";  
  $result = db_query($sql);  
  if (!$result) die('Invalid query: ' . mysql_error());
  else while (  $row  =  db_fetch_array($result) ) {
    $idPictoMSurcharge = $row['nid'];  
  ...
  */
  //Get nid of picto_surcharge to load the correct node edit form -> orni
  $idPictoMSurcharge = '';
  $sql = "SELECT n.nid, s.field_book_value_picto_surcharge_value, s.field_book_star_com_picto_value, s.field_book_star_on_picto_value FROM pimPierre.drp_node n LEFT JOIN pimPierre.drp_content_type_book_les_pictos_surcharge s ON s.nid = n.nid WHERE n.title='picto surcharge sur:".$nid."' AND s.field_book_type_picto_surcharge_value = 'mamifere' AND s.field_book_genre_picto_surcharge_value = 'interet';";  
  $result = db_query($sql);  
  if (!$result) die('Invalid query: ' . mysql_error());
  else while (  $row  =  db_fetch_array($result) ) {
    $idPictoMSurcharge = $row['nid'];  
  ...
  */
  //Get nid of picto_surcharge to load the correct node edit form -> orni
  $idPictoMSurcharge = '';
  $sql = "SELECT n.nid, s.field_book_value_picto_surcharge_value, s.field_book_star_com_picto_value, s.field_book_star_on_picto_value FROM pimPierre.drp_node n LEFT JOIN pimPierre.drp_content_type_book_les_pictos_surcharge s ON s.nid = n.nid WHERE n.title='picto surcharge sur:".$nid."' AND s.field_book_type_picto_surcharge_value = 'chiroptere' AND s.field_book_genre_picto_surcharge_value = 'interet';";  
  $result = db_query($sql);  
  if (!$result) die('Invalid query: ' . mysql_error());
  else while (  $row  =  db_fetch_array($result) ) {
    $idPictoMSurcharge = $row['nid'];  
  ...
  */
  //Get nid of picto_surcharge to load the correct node edit form -> orni
  $idPictoMSurcharge = '';
  $sql = "SELECT n.nid, s.field_book_value_picto_surcharge_value, s.field_book_star_com_picto_value, s.field_book_star_on_picto_value FROM pimPierre.drp_node n LEFT JOIN pimPierre.drp_content_type_book_les_pictos_surcharge s ON s.nid = n.nid WHERE n.title='picto surcharge sur:".$nid."' AND s.field_book_type_picto_surcharge_value = 'invert' AND s.field_book_genre_picto_surcharge_value = 'interet';";  
  $result = db_query($sql);  
  if (!$result) die('Invalid query: ' . mysql_error());
  else while (  $row  =  db_fetch_array($result) ) {
    $idPictoMSurcharge = $row['nid'];  
  ...
  */
  //Get nid of picto_surcharge to load the correct node edit form -> orni
  $idPictoMSurcharge = '';
  $sql = "SELECT n.nid, s.field_book_value_picto_surcharge_value, s.field_book_star_com_picto_value, s.field_book_star_on_picto_value FROM pimPierre.drp_node n LEFT JOIN pimPierre.drp_content_type_book_les_pictos_surcharge s ON s.nid = n.nid WHERE n.title='picto surcharge sur:".$nid."' AND s.field_book_type_picto_surcharge_value = 'paysT' AND s.field_book_genre_picto_surcharge_value = 'interet';";  
  $result = db_query($sql);  
  if (!$result) die('Invalid query: ' . mysql_error());
  else while (  $row  =  db_fetch_array($result) ) {
    $idPictoMSurcharge = $row['nid'];  
  ...
  */
  //Get nid of picto_surcharge to load the correct node edit form -> orni
  $idPictoMSurcharge = '';
  $sql = "SELECT n.nid, s.field_book_value_picto_surcharge_value, s.field_book_star_com_picto_value, s.field_book_star_on_picto_value FROM pimPierre.drp_node n LEFT JOIN pimPierre.drp_content_type_book_les_pictos_surcharge s ON s.nid = n.nid WHERE n.title='picto surcharge sur:".$nid."' AND s.field_book_type_picto_surcharge_value = 'paysM' AND s.field_book_genre_picto_surcharge_value = 'interet';";  
  $result = db_query($sql);  
  if (!$result) die('Invalid query: ' . mysql_error());
  else while (  $row  =  db_fetch_array($result) ) {
    $idPictoMSurcharge = $row['nid'];  
  ...
  * CREATION DE RICHESSE ECONOMIQUE - MER
  ...
  //Get nid of picto_surcharge to load the correct node edit form -> orni
  $idPictoMSurcharge = '';
  $sql = "SELECT n.nid, s.field_book_value_picto_surcharge_value, s.field_book_star_com_picto_value, s.field_book_star_on_picto_value FROM pimPierre.drp_node n LEFT JOIN pimPierre.drp_content_type_book_les_pictos_surcharge s ON s.nid = n.nid WHERE n.title='picto surcharge sur:".$nid."' AND s.field_book_type_picto_surcharge_value = 'ecoM' AND s.field_book_genre_picto_surcharge_value = 'interet';";  
  $result = db_query($sql);  
  if (!$result) die('Invalid query: ' . mysql_error());
  else while (  $row  =  db_fetch_array($result) ) {
    $idPictoMSurcharge = $row['nid'];  
  ...
  * CREATION DE RICHESSE ECONOMIQUE - TERRE
  ...
  //Get nid of picto_surcharge to load the correct node edit form -> orni
  $idPictoMSurcharge = '';
  $sql = "SELECT n.nid, s.field_book_value_picto_surcharge_value, s.field_book_star_com_picto_value, s.field_book_star_on_picto_value FROM pimPierre.drp_node n LEFT JOIN pimPierre.drp_content_type_book_les_pictos_surcharge s ON s.nid = n.nid WHERE n.title='picto surcharge sur:".$nid."' AND s.field_book_type_picto_surcharge_value = 'ecoT' AND s.field_book_genre_picto_surcharge_value = 'interet';";  
  $result = db_query($sql);  
  if (!$result) die('Invalid query: ' . mysql_error());
  else while (  $row  =  db_fetch_array($result) ) {
    $idPictoMSurcharge = $row['nid'];  
