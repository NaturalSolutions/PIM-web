  ...
  <tbody>
    <tr>
    	<td class="tableile-label">
         <div class="texte-gris"><?php print t($header['Zone_Geographique']); ?></div>
        </td>
        <td class="tableile-label">
          <div class="texte-gris"><?php print $header['Archipel']; ?></div>
        </td>
        <td class="tableile-label">
          <div class="texte-gris"><?php print $header['Noms_ile']; ?></div>
        </td>
    </tr>
    <?php foreach ($rows as $count => $row): ?>
      ...
      <tr >
        ...
        <td class="ficheile-value">
            <div class="texte-gris"><?php print $row['Archipel']; ?></div>
        </td>
        <td class="ficheile-value">
