  ...
  <div class="mr-propre"></div>
    ...
    <div id="main-wrapper" class="clearfix">
      ...
      <div id="content" class="column"><div class="section">
        ...
        <div id="fiche-ile">
          <div id="fiche-ile-border">
          
          <?php 
          global $base_url;
          $image_path = $base_url.'/sites/default/files/ficheIle/PIM_gris.png';
          //print '<img class="fiche_img" alt="island picture" src="'.$image_path.'">';
          print $fi_picture;
          
          ?>
          
          <div class="tabs" id="fiche-menu">
            <?php print $fi_primary_bdi; ?>
            <?php print $fi_bdn_title; ?>
            <div class="fi_bdn_fieldsets">
            <?php print $fi_primary_bdn; ?>
            <?php print $fi_primary_bota; ?>
            <?php print $fi_primary_chiro; ?>
            <?php print $fi_primary_entomo; ?>
            <?php print $fi_primary_marineff; ?>
            <?php print $fi_primary_herpeto; ?>
            <?php print $fi_primary_mamt; ?>
            <?php print $fi_primary_ornitho; ?>
            </div>
          </div>
        ...
        <div id="fiche-ile-content">
          <?php if ($fi_secondary): ?>
            <div class="tabs" id="level2"><?php print $fi_secondary; ?></div>
          <?php endif; ?>
          <?php print drupal_substr($content, 1); //print (trim($content, "\x00..\x20? \t\n\r\0\x3F")); ?>
        </div>
        </div> <!-- /#fiche-ile-border -->
      </div> <!-- /#fiche-ile -->
