    ...
    less: {
      ...
      compileCoreAtlas: {
        options: {
          ...
          sourceMap: true,
          outputSourceFiles: true,
          sourceMapURL: '<%= pkg.name %>-atlas.css.map',
          sourceMapFilename: 'dist/css/<%= pkg.name %>-atlas.css.map'
        },
        files: {
          'dist/css/<%= pkg.name %>-atlas.css': 'less/bootstrap-atlas.less'
        }
      },
      compileTheme: {
        options: {
      ...
      minify: {
        ...
        files: {
          ...
          'dist/css/<%= pkg.name %>-atlas.min.css': 'dist/css/<%= pkg.name %>-atlas.css'
    ...
    csscomb: {
      ...
      dist: {
        files: {
          ...
          'dist/css/<%= pkg.name %>-atlas.css': 'dist/css/<%= pkg.name %>-atlas.css'
        }
      },
      examples: {
        expand: true,
